				...
				<ul class="terms__list">
					<li class="terms__box">
						...
						<div class="terms__content">
							여러분을 환영합니다. JUN 서비스 및 제품(이하
							‘서비스’)을 이용해 주셔서 감사합니다. 본 약관은 다양한 JUN 서비스의 이용과 관련하여 JUN 서비스를 제공하는
							JUN 주식회사(이하 ‘JUN’)와 이를 이용하는 JUN 서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를
							설명하며, 아울러 여러분의 JUN 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다. JUN 서비스를
							이용하시거나 JUN 서비스 회원으로 가입하실 경우 여러분은 본 약관 및 관련 운영 정책을 확인하거나 동의하게 되므로,
					...
					<li class="terms__box">
						...
						<div class="terms__content">
							개인정보보호법에 따라 JUN에 회원가입 신청하시는 분께
					...
					<li class="terms__box">
						...
						<div class="terms__content">
							JUN에서 제공하는 이벤트/혜택 등 다양한 정보를
							휴대전화(JUN앱 알림 또는 문자), 이메일로 받아보실 수 있습니다. 일부 서비스(별도 회원 체계로 운영하거나 JUN
